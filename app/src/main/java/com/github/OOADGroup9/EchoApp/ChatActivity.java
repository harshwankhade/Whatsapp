...
{  private String messageReceiverID, messageReceiverName, messageReceiverImage, messageSenderID;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (getIntent().getExtras() == null) {
            Toast.makeText(this, "Error: No chat data provided", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }

        messageReceiverID = getIntent().getExtras().get("visit_user_id") != null ? getIntent().getExtras().get("visit_user_id").toString() : "";
        messageReceiverName = getIntent().getExtras().get("visit_user_name") != null ? getIntent().getExtras().get("visit_user_name").toString() : "";
        messageReceiverImage = getIntent().getExtras().get("visit_image") != null ? getIntent().getExtras().get("visit_image").toString() : "";
    ...
    private void IntializeControllers() {
        ...
        // Find views from the custom_chat_bar layout, not from the activity layout
        ...
        if (userMessagesList != null) {
            ...
            Toast.makeText(this, "Error: Messages list not found", Toast.LENGTH_SHORT).show();
        }
